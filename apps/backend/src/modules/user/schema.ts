...
export const userResetPasswordDataModel: JSONSchemaType<TPostUserResetPasswordDataDTO> = {
...
export const userResetPasswordSchema: ISchema = {
  schema: {
    tags,
    body: userResetPasswordDataModel,
    response: { 200: baseReply },
  },
};
