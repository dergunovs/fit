...
describe('ActivityStatistics', async () => {
  ...
  it('shows total statistics data', async () => {
    expect(wrapper.find(totalDuration).text()).toBe(formatDuration(statistics.duration.cur, 'ru', true));
  ...
  it('shows average statistics data', async () => {
    expect(wrapper.find(averageDuration).text()).toBe(formatDuration(statistics.averageDuration.cur, 'ru', true));
