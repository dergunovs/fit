<template>
  <UiFlex column>
    <div>
      Научный подход к тренировкам основан на принципах физиологии, биомеханики и спортивной медицины, а не на
      интуитивных или модных методиках. Например, доказано, что прогрессивная нагрузка стимулирует рост мышц и силы.
    </div>
